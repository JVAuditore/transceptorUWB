...
#set_property PACKAGE_PIN U9 [get_ports mode_select]					
#	set_property IOSTANDARD LVCMOS33 [get_ports mode_select]
###Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {read_output}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {read_output}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {write_input}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {write_input}]
...
#set_property PACKAGE_PIN K5 [get_ports clk_1hz]					
...
#set_property PACKAGE_PIN F14 [get_ports {cs_n}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {cs_n}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {sck}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sck}]
#Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {ready}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ready}]
#Bank = 15, Pin name = IO_0_15,								Sch name = JA7
#set_property PACKAGE_PIN G13 [get_ports {start}]					
