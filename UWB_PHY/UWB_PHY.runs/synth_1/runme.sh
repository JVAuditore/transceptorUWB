...
HD_PWD='D:/UNB_HD/TCC/transceptorUWB/UWB_PHY/UWB_PHY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uwb_phy_riscv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uwb_phy_riscv.tcl
