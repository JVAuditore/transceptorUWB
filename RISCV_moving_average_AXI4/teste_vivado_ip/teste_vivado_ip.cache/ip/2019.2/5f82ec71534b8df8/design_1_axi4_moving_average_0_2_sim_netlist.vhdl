...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fsm is
  port (
    ...
    slv_reg0 : out STD_LOGIC_VECTOR ( 0 to 0 );
...
\genblk1[0].reg_shift\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_8
     port map (
      ...
      \Q_reg[18]\(1 downto 0) => Q(16 downto 15),
...
media_movel: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_moving_avg
     port map (
      E(0) => slv_reg0(2),
      \FSM_onehot_state_reg[0]\(0) => slv_reg0(0),
      Q(15) => media_movel_n_2,
      Q(14) => media_movel_n_3,
      Q(13) => media_movel_n_4,
      Q(12) => media_movel_n_5,
      Q(11) => media_movel_n_6,
      Q(10) => media_movel_n_7,
      Q(9) => media_movel_n_8,
      Q(8) => media_movel_n_9,
      Q(7) => media_movel_n_10,
      Q(6) => media_movel_n_11,
      Q(5) => media_movel_n_12,
      Q(4) => media_movel_n_13,
      Q(3) => media_movel_n_14,
      Q(2) => media_movel_n_15,
      Q(1) => media_movel_n_16,
      Q(0) => media_movel_n_17,
