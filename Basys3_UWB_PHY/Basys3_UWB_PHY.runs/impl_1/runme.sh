...
HD_PWD='D:/UNB_HD/TCC/transceptorUWB/Basys3_UWB_PHY/Basys3_UWB_PHY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uwb_phy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uwb_phy.tcl -notrace
