...
namespace eval ::optrace {
  variable script "D:/UNB_HD/TCC/transceptorUWB/Basys3_UWB_PHY/Basys3_UWB_PHY.runs/synth_1/uwb_phy.tcl"
...
synth_design -top uwb_phy -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef uwb_phy.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file uwb_phy_utilization_synth.rpt -pb uwb_phy_utilization_synth.pb"
