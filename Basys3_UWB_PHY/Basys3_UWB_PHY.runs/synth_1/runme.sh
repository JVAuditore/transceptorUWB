...
HD_PWD='D:/UNB_HD/TCC/transceptorUWB/Basys3_UWB_PHY/Basys3_UWB_PHY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uwb_phy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uwb_phy.tcl
